	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'float': { '0%,100%': { transform: 'translateY(0px) rotate(0deg)' }, '33%': { transform: 'translateY(-14px) rotate(0.8deg)' }, '66%': { transform: 'translateY(-7px) rotate(-0.8deg)' } },
				...
				'aurora-move': { '0%,100%': { transform: 'translate(0, 0) scale(1)', opacity: '0.5' }, '33%': { transform: 'translate(30px, -20px) scale(1.05)', opacity: '0.7' }, '66%': { transform: 'translate(-20px, 15px) scale(0.97)', opacity: '0.4' } },
				'ticker-scroll': { '0%': { transform: 'translateX(0)' }, '100%': { transform: 'translateX(-50%)' } },
				'border-glow': { '0%,100%': { borderColor: 'rgba(59,130,246,0.3)' }, '50%': { borderColor: 'rgba(59,130,246,0.7)' } },
			},
			animation: {
